...
// MIMO Configuration: 16x16 with 16QAM at SNR25
// Optimized ap_fixed types for 16x16 MIMO system with 16QAM modulation

/*优化后的数据类型 - 16x16 16QAM SNR25*/
// 变量: step_size
typedef ap_fixed<20, 5> step_size_t;

// 变量: r_norm
typedef ap_fixed<20, 10> r_norm_t;

// 变量: r_norm_survivor
typedef ap_fixed<8, 5> r_norm_survivor_t;

// 变量: lr
typedef ap_fixed<18, 5> lr_t;

// 变量: r_norm_prop
typedef ap_fixed<19, 10> r_norm_prop_t;

// 变量: z_grad_real
typedef ap_fixed<24, 5> z_grad_real_t;

// 变量: z_grad_imag
typedef ap_fixed<24, 5> z_grad_imag_t;

// 变量: z_prop_real
typedef ap_fixed<23, 7> z_prop_real_t;

// 变量: z_prop_imag
typedef ap_fixed<23, 7> z_prop_imag_t;

// 变量: x_prop_real
typedef ap_fixed<48, 10> x_prop_real_t;

// 变量: x_prop_imag
typedef ap_fixed<48, 10> x_prop_imag_t;
...
// 变量: HH_H_real
typedef ap_fixed<28, 5> HH_H_real_t;

// 变量: HH_H_imag
typedef ap_fixed<28, 5> HH_H_imag_t;

// 变量: grad_preconditioner_real
typedef ap_fixed<28, 10> grad_preconditioner_real_t;

// 变量: grad_preconditioner_imag
typedef ap_fixed<28, 10> grad_preconditioner_imag_t;

// 变量: x_mmse_real
typedef ap_fixed<48, 10> x_mmse_real_t;

// 变量: x_mmse_imag
typedef ap_fixed<48, 10> x_mmse_imag_t;
...
// 变量: temp_NtNt_real
typedef ap_fixed<48, 10> temp_NtNt_real_t;

// 变量: temp_NtNt_imag
typedef ap_fixed<48, 10> temp_NtNt_imag_t;
...
// 变量: temp_1_real
typedef ap_fixed<20, 10> temp_1_real_t;

// 变量: temp_1_imag
typedef ap_fixed<2, 1> temp_1_imag_t;

// 变量: _temp_1_real
typedef ap_fixed<22, 10> _temp_1_real_t;

// 变量: _temp_1_imag
typedef ap_fixed<2, 1> _temp_1_imag_t;

// 变量: temp_Nt_real
typedef ap_fixed<28, 5> temp_Nt_real_t;

// 变量: temp_Nt_imag
typedef ap_fixed<28, 5> temp_Nt_imag_t;
...
// 变量: local_temp_1
typedef ap_fixed<48, 10> local_temp_1_t;

// 变量: local_temp_2
typedef ap_fixed<48, 10> local_temp_2_t;
...
typedef ap_fixed<48,10> like_float;
typedef ap_fixed<48,10> Myreal;
typedef ap_fixed<48,10> Myimage;
